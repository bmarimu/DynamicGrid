...
namespace sample_GridStack.Models
{
    ...
    {
        private static readonly string DatabaseId = ConfigurationManager.AppSettings["MyWorkspaceDocumentDB"];
        private static readonly string CollectionId = ConfigurationManager.AppSettings["MyWorkspaceCollection"];
        private static DocumentClient client;

        public static void Initialize()
        {
            client = new DocumentClient(new Uri(ConfigurationManager.AppSettings["DocumentDBAddress"]), ConfigurationManager.AppSettings["DocumentDBAuthKey"]);
